...
if (isset($_POST['send'])) {
    ...
    $myEmail = "ma9856603@gmail.com";
    $subject = "Contact Form";
    $header = "From: " . $email . "\n\r";

    // $connection = new PDO('mysql:host=sql207.eb2a.com;dbname=eb2a_33593927_contact_form;', 'eb2a_33593927', '');
    $connection = new PDO('mysql:host=localhost;dbname=contact_form', 'root', '');
    if (isset($_POST['send']) && empty($Errors)) {
        mail($myEmail, $subject, $mesage, $header);
